...
const BaseButton = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(Comp, { "data-accent-color": color, "data-radius": radius, ...baseButtonProps, ref: forwardedRef, className: classNames('rt-reset', 'rt-BaseButton', className, withBreakpoints(size, 'rt-r-size'), `rt-variant-${variant}`, { 'rt-high-contrast': highContrast }, withMarginProps(marginProps)) }));
});
