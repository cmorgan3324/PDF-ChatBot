...
var ContextChatEngine = class {
  constructor(init) {
    ...
    this.contextSystemPrompt = (_c = init == null ? void 0 : init.contextSystemPrompt) != null ? _c : defaultContextSystemPrompt;
  }
  chat(message, chatHistory) {
    return __async(this, null, function* () {
      chatHistory = chatHistory != null ? chatHistory : this.chatHistory;
...
var HistoryChatEngine = class {
  constructor(init) {
    var _a, _b;
    this.chatHistory = (_a = init == null ? void 0 : init.chatHistory) != null ? _a : new SimpleChatHistory();
    this.llm = (_b = init == null ? void 0 : init.llm) != null ? _b : new OpenAI2();
  }
  chat(message) {
    return __async(this, null, function* () {
      this.chatHistory.addMessage({ content: message, role: "user" });
      const response = yield this.llm.chat(this.chatHistory.messages);
...
var SimpleKVStore = class _SimpleKVStore extends BaseKVStore {
  ...
  put(_0, _1) {
    return __async(this, arguments, function* (key, val, collection = DEFAULT_COLLECTION) {
      ...
      this.data[collection][key] = _4.clone(val);
      if (this.persistPath) {
  ...
  get(_0) {
    return __async(this, arguments, function* (key, collection = DEFAULT_COLLECTION) {
      ...
      if (_4.isNil(collectionData)) {
        return null;
      }
      if (!(key in collectionData)) {
        return null;
      }
      return _4.clone(collectionData[key]);
    });
  }
  getAll() {
    return __async(this, arguments, function* (collection = DEFAULT_COLLECTION) {
      return _4.clone(this.data[collection]);
    });
  }
  delete(_0) {
    return __async(this, arguments, function* (key, collection = DEFAULT_COLLECTION) {
...
import _5, * as lodash from "lodash";
...
var KVDocumentStore = class extends BaseDocumentStore {
    ...
    return __async(this, null, function* () {
      for (var idx = 0; idx < docs.length; idx++) {
        ...
        if (doc.getType() === "TEXT" /* TEXT */ && doc.sourceNode !== void 0) {
          ...
          if (_5.isEmpty(refDocInfo.extraInfo)) {
  ...
  getRefDocInfo(refDocId) {
    return __async(this, null, function* () {
      ...
      return refDocInfo ? _5.clone(refDocInfo) : void 0;
    });
  }
  getAllRefDocInfo() {
    return __async(this, null, function* () {
      let refDocInfos = yield this.kvstore.getAll(this.refDocCollection);
      if (_5.isNil(refDocInfos)) {
        return;
      }
      return refDocInfos;
    });
  ...
  refDocExists(refDocId) {
    return __async(this, null, function* () {
      return !_5.isNil(yield this.getRefDocInfo(refDocId));
    });
  }
  documentExists(docId) {
    return __async(this, null, function* () {
      return !_5.isNil(yield this.kvstore.get(docId, this.nodeCollection));
    });
  }
  ...
  getDocumentHash(docId) {
    return __async(this, null, function* () {
      let metadata = yield this.kvstore.get(docId, this.metadataCollection);
      return _5.get(metadata, "docHash");
    });
  }
};
